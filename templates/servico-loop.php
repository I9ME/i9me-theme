 ...
 ?>
		...
		<div class="boxes">
			<div class="container-full">
				...
				<div class="boxes__box-left">
					...
					<header class="header-section header-section--area-design left-padding--interCol">
				...
				<div class="boxes__box-right">
					...
					<ul class="lista lista--design right-padding--interCol">
						<?php
	...
	<article class="servicos__web" id="web">
		<div class="boxes boxes--reverse">
			...
			<div class="container-full">
				<div class="boxes__box-right">
					<ul class="lista lista--web left-padding--interCol">
						<?php
							$tax_slug =  'tipo-de-servico';
				...
				<div class="boxes__box-left">
					<header class="header-section header-section--area-design header-section--area-web right-padding--interCol">
